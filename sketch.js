...
function setup() {
	...
	bob1 = Bodies.circle(310,300,20,bob_options);
	World.add(world,bob1);

	bob2 = Bodies.circle(345,300,20,bob_options);
	World.add(world,bob2);

	bob3 = Bodies.circle(380,300,20,bob_options);
	World.add(world,bob3);

	bob4 = Bodies.circle(415,300,20,bob_options);
